...
@section('content')
  @if (Route::has('login'))
    <div class="fixed top-0 right-0 hidden px-6 py-4 sm:block">
      ...
      @else
        <a class="text-sm text-gray-700 underline dark:text-gray-500" href="{{ route('login') }}">Log
          in</a>
          ...
          <div class="ml-12">
            <div class="mt-2 text-sm text-gray-600 dark:text-gray-400">
              Laravel's robust library of first-party tools and libraries, such as <a
                 ...
                 href="https://envoyer.io">Envoyer</a> help you take your
              projects to the next level. Pair them with powerful open source libraries like <a
                 ...
                 class="underline" href="https://laravel.com/docs/dusk">Dusk</a>, <a class="underline"
                 ...
                 href="https://laravel.com/docs/telescope">Telescope</a>, and
              more.
            </div>
          </div>
        </div>
